...
#term("gan") là cơ quan nội tạng lớn nhất (khoảng 1.4 kg) và đảm nhiệm hơn 500 chức năng khác nhau:
...
== Chuyển hóa — Cơ thể dùng năng lượng thế nào?

#term("chuyen-hoa") (metabolism) là tổng thể các phản ứng hóa học trong cơ thể để duy trì sự sống. Gồm hai quá trình đối lập:
...
Chế độ ăn ảnh hưởng mạnh đến thành phần hệ vi sinh. Người ăn nhiều chất xơ (rau, củ, quả, ngũ cốc nguyên hạt) có hệ vi sinh đa dạng và khỏe mạnh hơn người ăn nhiều thức ăn chế biến sẵn, ít chất xơ @sonnenburg2014.
