...
=== Thân não (Brainstem) — Bộ điều khiển nền tảng
...
=== Tiểu não (Cerebellum) — Bộ điều phối vận động
...
=== Hệ viền (Limbic system) — Trung tâm cảm xúc
...
- *Thùy trán (Frontal lobe):* Lập kế hoạch, ra quyết định, kiểm soát xung động. Phần #term("thuy-truoc-tran") được xem là "trung tâm điều hành" của não.
...
#muc-bang-chung("B")[
  *Bộ não không có "trung tâm ngôn ngữ" duy nhất:* Quan niệm phổ biến cho rằng vùng Broca (nói) và Wernicke (hiểu) là hai trung tâm ngôn ngữ độc lập. Thực tế, quét não hiện đại cho thấy ngôn ngữ liên quan đến một mạng lưới rộng khắp não, bao gồm nhiều vùng ngoài hai khu vực kinh điển. Mô hình "hai trung tâm" là một đơn giản hóa hữu ích nhưng không phản ánh đầy đủ sự phức tạp thực tế @sapolsky2017.
]

== Hệ thần kinh tự chủ — Lái tự động

#term("he-than-kinh-tu-chu") điều khiển các chức năng không tự ý — nhịp tim, tiêu hóa, nhịp thở — mà bạn không cần nghĩ đến. Nó được chia làm hai nhánh đối lập:
...
== Tính mềm dẻo thần kinh — Não có thể thay đổi
...
Tính mềm dẻo thần kinh (neuroplasticity) là khả năng của não thay đổi cấu trúc và chức năng để đáp ứng với kinh nghiệm @doidge2007. Điều này có nghĩa:
...
#muc-bang-chung("A")[
  *Tái tổ chức vỏ não ở người mù:* Những người mù bẩm sinh sử dụng vùng vỏ não thị giác — vốn xử lý hình ảnh — để xử lý xúc giác và chữ nổi Braille. Đây là một trong những bằng chứng rõ ràng nhất về tính mềm dẻo thần kinh @merzenich2013. Não không lãng phí "không gian": vùng không nhận được kích thích thị giác sẽ được các giác quan khác tận dụng.
]
