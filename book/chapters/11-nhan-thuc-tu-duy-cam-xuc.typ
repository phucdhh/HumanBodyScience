...
Chương này khám phá những gì khoa học biết được về #term("nhan-thuc") — tư duy, trí nhớ, cảm xúc và ra quyết định.

== Hai hệ thống tư duy

Nhà tâm lý học Daniel Kahneman — người đoạt Nobel Kinh tế — mô tả bộ não có hai hệ thống tư duy @kahneman2011:
...
#figure(
  ...
  caption: [Vùng não điều hòa cảm xúc và ra quyết định]
)
...
=== Hạnh phúc — Hệ thống phần thưởng
