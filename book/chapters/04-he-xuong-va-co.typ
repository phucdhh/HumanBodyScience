...
- Não bộ: ảnh hưởng đến tâm trạng và trí nhớ @karsenty2012.
...
=== Loãng xương và sự thật về canxi
...
Nếu xương chỉ là các thanh cứng rời rạc, bạn sẽ bất động như pho tượng. Khớp và dây chằng biến bộ khung đó thành cỗ máy linh hoạt — từ xâu kim đến nhảy cao.
...
=== Thoái hóa khớp — "Mòn" chứ không phải "viêm"
