...
= Nhập môn: Khoa học biết điều này bằng cách nào?
...
Trong y học, để biết một phương pháp điều trị hay một loại thuốc có thực sự hiệu quả hay không, các nhà khoa học sử dụng #term("rct").

Mấu chốt của thử nghiệm này là sự hiện diện của #term("nhom-chung"). Nếu không có nhóm chứng, chúng ta không thể loại trừ hiệu ứng giả dược (placebo) hoặc sự tự phục hồi tự nhiên của cơ thể.
