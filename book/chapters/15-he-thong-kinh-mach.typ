...
== Huyệt — Kích thích và tác dụng sinh học

Các #term("huyet") trên cơ thể — dù có hay không có kinh mạch theo nghĩa cổ truyền — đã được nghiên cứu nhiều bằng phương pháp hiện đại. Các điểm huyệt thường có các đặc điểm:
...
=== Châm cứu và kích thích thần kinh
...
Giá trị của khái niệm kinh mạch có thể không nằm ở tính hiện thực giải phẫu, mà ở chỗ nó cung cấp một mô hình làm việc để tổ chức kiến thức về các điểm tác động trên cơ thể — một hệ thống phân loại đã giúp các thầy thuốc cổ truyền thực hành trong hàng nghìn năm.
...
4. Tại sao sự tương đồng giữa các hệ thống "kênh năng lượng" ở nhiều nền văn hóa không phải là bằng chứng khoa học cho sự tồn tại của chúng?
