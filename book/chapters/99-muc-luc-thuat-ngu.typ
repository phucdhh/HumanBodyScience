...
#grid(
  ...
  [*Canxi* (Calcium) -- Khoáng chất quan trọng cho xương, răng và co cơ],
  [*Carbohydrate* -- Đường và tinh bột, nguồn năng lượng chính của cơ thể],
  [*Châm cứu* (Acupuncture) -- Phương pháp Đông y dùng kim châm vào huyệt để chữa bệnh],
...
#grid(
  ...
  [*Phế nang* (Alveolus) -- Túi khí nhỏ trong phổi, nơi trao đổi oxy và CO₂],
  [*Phế quản* (Bronchus) -- Ống khí lớn dẫn không khí vào phổi],
  [*Phospholipid* -- Lipid có nhóm phosphate, thành phần chính màng tế bào],
  [*Phốt pho* (Phosphorus) -- Khoáng chất kết hợp với canxi tạo xương],
...
#grid(
  ...
  [*Telomere* -- Đầu mút nhiễm sắc thể, bảo vệ ADN, ngắn dần khi lão hóa],
  ...
  [*Tiểu hóa* (Digestive) -- Hệ thống phân giải thức ăn thành chất dinh dưỡng],
  ...
  [*Trí nhớ* (Memory) -- Khả năng lưu trữ và gợi nhớ thông tin],
...
#align(center)[
  _Mục lục thuật ngữ này được tạo tự động từ file `glossary/thuat-ngu.typ`_ \
  _Phiên bản cập nhật: Tháng 7, 2026_
]
