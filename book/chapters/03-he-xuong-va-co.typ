...
== Bộ xương — Khung đỡ và Nhà máy tạo máu
...
=== 1. Giải phẫu hệ xương: Khung gầm của cơ thể
...
=== 2. Kiến trúc vi thể: Xương đặc và Xương xốp
...
=== 3. Chu trình tái tạo xương: Một công trường xây dựng không ngừng nghỉ
...
=== 4. Vai trò nội tiết của xương: Khám phá mới mẻ của thế kỷ 21
...
=== 5. Xương là nhà máy tạo máu (Hematopoiesis)
Bên trong các không gian rỗng của xương xốp chứa tủy xương. Có hai loại tủy xương: tủy đỏ và tủy vàng.
Ở trẻ sơ sinh, hầu hết xương đều chứa tủy đỏ. Khi lớn lên, tủy đỏ ở thân xương dài dần dần được thay thế bằng mô mỡ (tủy vàng). Ở người trưởng thành, tủy đỏ tập trung chủ yếu ở xương chậu, xương ức, hộp sọ, xương sườn và các đầu xương dài.
...
=== 6. Loãng xương (Osteoporosis) và Các lầm tưởng về Canxi
...
#muc-bang-chung("B")[
  *Quan niệm: Cứ uống nhiều Canxi là sẽ chống được loãng xương.* \
  ...
  Để Canxi có thể hấp thu qua ruột vào máu, cơ thể bắt buộc phải có *Vitamin D3*. Và quan trọng hơn, để Canxi trong máu biết đường "chạy" vào xương và gắn kết vào khuôn collagen, cơ thể cần đến *Vitamin K2* và tín hiệu cơ học từ việc *vận động thể chất*. Do đó, việc bổ sung bừa bãi các viên uống Canxi liều cao đơn chất không mang lại lợi ích chống loãng xương như kỳ vọng, mà thậm chí có thể làm tăng nguy cơ biến chứng tim mạch.
]

== Khớp và Dây chằng — Cỗ máy chuyển động

Bộ xương nếu chỉ là các thanh cứng nhắc rời rạc thì cơ thể sẽ bất động như một pho tượng. Chính hệ thống khớp và dây chằng đã biến cấu trúc cứng đó thành một cỗ máy linh hoạt phi thường, có thể thực hiện từ những chuyển động tinh tế như xâu kim cho đến những vận động bùng nổ như nhảy cao.

=== 1. Phân loại khớp theo cấu trúc và chức năng
...
=== 2. Giải phẫu vi thể của khớp hoạt dịch (Synovial joint)
...
Theo thời gian và dưới tác động của tải trọng tích lũy, lớp sụn khớp bắt đầu bị bào mòn, nứt vỡ và mỏng dần. Khi lớp đệm sụn bị mất, hai bề mặt xương tiếp xúc trực tiếp với nhau, gây đau dữ dội và hạn chế vận động. Cơ thể cố gắng bù đắp bằng cách hình thành các gai xương (osteophytes) ở rìa khớp, nhưng những gai xương này lại gây thêm đau và hạn chế cử động.
...
=== 1. Cơ chế co cơ ở cấp độ phân tử: Thuyết trượt sợi
...
3. Tín hiệu điện này kích hoạt lưới nội chất cơ (Sarcoplasmic Reticulum) giải phóng ồ ạt ion Canxi (Ca²⁺) vào tế bào chất.
4. Ion Ca²⁺ gắn vào protein điều tiết Troponin trên sợi Actin, làm thay đổi hình dạng của nó và phơi bày ra vị trí bám cho Myosin.
...
7. Khi xung thần kinh dừng, Ca²⁺ được bơm trở lại vào lưới nội chất, Troponin che lại vị trí bám, và cơ giãn ra.

=== 2. Phân loại sợi cơ: Chạy đường dài hay nước rút?
...
=== 3. Năng lượng cho cơ bắp: Ba hệ thống sản xuất ATP
...
#muc-bang-chung("B")[
  *Sự phì đại cơ (Hypertrophy) và tập luyện kháng lực:* Khi bạn nâng tạ, bạn đang gây ra những vi tổn thương (micro-tears) nhỏ ở các sợi cơ. Trong quá trình hồi phục sau đó, cơ thể kích hoạt các tế bào vệ tinh (satellite cells) — tế bào gốc cơ bắp — để tổng hợp thêm protein co rút mới, làm dày và chắc thêm các sợi cơ hiện có.
