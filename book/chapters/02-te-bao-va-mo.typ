...
== Lịch sử và Học thuyết Tế bào

Lịch sử của sinh học hiện đại gắn liền với sự phát triển của quang học. Vào thế kỷ 17, nhà khoa học người Anh Robert Hooke đã sử dụng một chiếc kính hiển vi thô sơ để quan sát lát bần mỏng. Ông nhận thấy cấu trúc của bần bao gồm vô số những khoang nhỏ rỗng, trông giống như những căn phòng nhỏ của các tu sĩ trong tu viện, nên ông đã gọi chúng là "cell" (tế bào). Tuy nhiên, những gì Hooke nhìn thấy chỉ là thành tế bào thực vật đã chết.
...
3. Tất cả các tế bào đều được sinh ra từ các tế bào có trước thông qua quá trình phân bào @example.
...
== Màng tế bào — "Người gác cổng"

Mọi tế bào đều được bao bọc bởi một lớp màng siêu mỏng gọi là màng tế bào (Cell membrane) hay màng sinh chất. Màng này không phải là một bức tường tĩnh lặng, mà là một cấu trúc cực kỳ năng động được mô tả bởi *Mô hình khảm động* (Fluid mosaic model).
...
*Sự truyền tin tế bào (Cell signaling)* \
...
== Bào quan — "Nhà máy thu nhỏ"

Bên trong màng tế bào là một không gian chứa dịch gọi là tế bào chất (Cytoplasm). Nổi lơ lửng trong đó là hàng loạt các bào quan (Organelles), mỗi bào quan đảm nhiệm một chức năng chuyên biệt, giống như các phòng ban trong một nhà máy.

- *#term("ti-the"):* Đây là "nhà máy điện" của tế bào, nơi diễn ra quá trình hô hấp tế bào để chuyển hóa đường và oxy thành năng lượng dưới dạng ATP. Một điểm đặc biệt là ti thể sở hữu một lượng nhỏ DNA riêng (mtDNA) và ở người, toàn bộ DNA ti thể này đều được di truyền từ mẹ.
...
== Nhân tế bào và Chu kỳ sống

Nhân tế bào (Nucleus) là bào quan lớn nhất và quan trọng nhất, đóng vai trò là "trung tâm chỉ huy". Nó được bao bọc bởi một lớp màng kép và chứa đựng toàn bộ bản thiết kế sự sống của bạn: #term("ad").

Trong nhân, DNA không nằm lộn xộn mà được quấn chặt quanh các protein (histone) tạo thành cấu trúc gọi là *#term("chromatin")*. Khi tế bào chuẩn bị phân chia, chromatin sẽ cuộn chặt hơn nữa để tạo thành các nhiễm sắc thể rõ ràng.

*Chu kỳ phân bào và Sự biệt hóa* \
Cơ thể người phát triển từ một tế bào duy nhất (hợp tử) thông qua quá trình phân bào nguyên phân (*#term("mitosis")*). Quá trình này tạo ra hai tế bào con giống hệt nhau về mặt di truyền. Tuy nhiên, nếu tất cả đều giống nhau, làm sao ta có tế bào mắt, tế bào gan hay tế bào cơ? Đó là nhờ quá trình *biệt hóa tế bào*. Các tế bào khác nhau sẽ "bật" hoặc "tắt" các đoạn gene khác nhau tùy thuộc vào vị trí và chức năng của chúng.

*Quá trình phân bào giảm phân (#term("meiosis"))* \
