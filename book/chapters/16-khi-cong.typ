...
Chương này xem xét khí công dưới hai góc nhìn: như một hiện tượng văn hóa-lịch sử và như một can thiệp sức khỏe có thể kiểm tra bằng phương pháp khoa học.
...
- *Đạo dẫn* (导引) — các bài tập vận động kết hợp hơi thở, xuất hiện từ thời Chiến Quốc (thế kỷ 5-3 TCN). Bằng chứng khảo cổ: bức tranh lụa Mã Vương Đôi (168 TCN) vẽ các tư thế tập luyện.
...
Một phân tích gộp năm 2016 tổng hợp 10 RCT với hơn 1.500 người lớn tuổi cho thấy Thái Cực Quyền (có nền tảng khí công) giảm 43% nguy cơ té ngã so với các bài tập thông thường @huston2016.

#muc-bang-chung("A")[
  *Khí công và phòng té ngã:* Bằng chứng vững chắc cho thấy các bài tập chậm có kiểm soát (như Thái Cực Quyền và khí công) cải thiện thăng bằng, sức mạnh cơ bắp chân, và giảm nguy cơ té ngã ở người lớn tuổi. Cơ chế bao gồm: tăng cường sức mạnh cơ tử chi dưới, cải thiện cảm nhận tư thế (proprioception), và tăng tự tin khi vận động.
]

=== Đau mãn tính

Một phân tích gộp năm 2020 của 15 RCT cho thấy khí công giảm đau hiệu quả hơn không can thiệp và tương đương với các bài tập vật lý trị liệu thông thường trong điều trị đau cổ vai gáy và đau lưng dưới @lee2020.

=== Sức khỏe tinh thần

Tổng quan hệ thống năm 2018 trên 25 RCT (2.100 người tham gia) cho thấy khí công cải thiện các triệu chứng lo âu và trầm cảm ở mức độ nhẹ đến trung bình, với mức cải thiện tương tự các can thiệp tâm-thân khác (yoga, thiền) @wang2018.

=== Huyết áp và sức khỏe tim mạch

Một phân tích gộp 2015 (20 RCT, 2.400 người) ghi nhận tập khí công ít nhất 12 tuần có tác dụng giảm huyết áp tâm thu trung bình 5-8 mmHg so với nhóm chứng @zheng2015.
...
== Cơ chế tác dụng — Các giả thuyết khoa học
...
=== Tăng cường thể lực và thăng bằng
...
=== Hiệu ứng giả dược và nghi thức trị liệu
...
#muc-bang-chung("C")[
  *Khí công ngoại khí — Ngoại khí có thật không?* Trong y liệu khí công, một số thầy thuốc tin rằng họ có thể phát "khí" từ tay mình để chữa bệnh cho người khác (ngoại khí — external qigong). Các nghiên cứu khoa học về ngoại khí — đặc biệt là các thử nghiệm có kiểm soát — hầu hết cho kết quả âm tính hoặc không tái lập được. Hiện tại, ngoại khí được xếp mức D: quan niệm truyền thống, chưa có bằng chứng khoa học đáng tin cậy.
]
...
Lưu ý: Thái Cực Quyền và khí công có nhiều điểm chung. Một số nghiên cứu gộp chung hai loại hình này, gây khó khăn khi tách riêng tác dụng.
...
- *Chưa rõ:* Các tuyên bố về chữa bệnh đặc hiệu hoặc ngoại khí (Mức C/D).
- *Không có bằng chứng:* Phát khí chữa bệnh từ xa, thay thế y học hiện đại (Mức D).

Giống như châm cứu, khí công có thể là một bổ sung an toàn và có lợi cho sức khỏe tổng thể, nhưng không nên thay thế các phương pháp điều trị có bằng chứng mạnh hơn.
