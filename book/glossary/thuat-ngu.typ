...
#let thuat-ngu = (
  ...
  "co-sinh-hoc": ("Cơ sinh học", "Biomechanics", "Nghiên cứu nguyên lý cơ học của cơ thể sống"),
  "mo-phong-sinh-hoc": ("Mô phỏng sinh học", "Biomimetics/Bionics", "Ứng dụng các thiết kế và quá trình sinh học vào kỹ thuật"),
  ...
  "mien-dich-cong-dong": ("Miễn dịch cộng đồng", "Herd immunity", "Trạng thái bảo vệ gián tiếp khi một tỷ lệ lớn dân số đã có miễn dịch"),
  ...
  "luc-phu-ngu-tang": ("Lục phủ ngũ tạng", "Zang-fu organs", "Hệ thống các cơ quan nội tạng trong Đông y"),
  "tam-bao": ("Tâm bào", "Pericardium", "Màng bọc bảo vệ tim (Đông y)"),
  "tam-tieu": ("Tam tiêu", "Triple Burner / San Jiao", "Ba khoang cơ thể điều hòa khí và nước (Đông y)"),
